...
import helmet from '../assets/16075168592598001078830544115.glb';
import glasses2 from '../assets/160751694212008215306940425982.glb';
import hdri from '../assets/kloppenheim_06_1k.hdr';
import './index.sass';
...
var model: THREE.Object3D | undefined = undefined;
...
function loadModel(mod:any){
  const gltfLoader = new GLTFLoader(manager);
gltfLoader.load(mod, (gltf) => {
  // Position the loaded content to overlay user's face
  gltf.scene.position.set(0.0, 0.1,0.3);
